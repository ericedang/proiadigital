...
const products = [
  // Digitalisation
  { id: 'p1', name: 'Pack Digitalisation PME', price: 450000, category: 'Digitalisation', desc: 'Propulsez votre entreprise dans l\'ère moderne. Ce pack transforme vos processus manuels en flux digitaux fluides, vous permettant de gagner 30% de productivité dès le premier trimestre. Inclut un site web haute performance et une stratégie sociale automatisée.', image: 'https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?auto=format&fit=crop&q=80&w=800' },
  { id: 'p11', name: 'Pack Web Vitrine', price: 300000, category: 'Digitalisation', desc: 'Ne soyez plus invisible. Attirez de nouveaux clients avec une vitrine digitale qui reflète votre excellence. Un site optimisé pour convertir vos visiteurs en partenaires fidèles.', image: 'https://images.unsplash.com/photo-1556761175-129418cb210d?auto=format&fit=crop&q=80&w=800' },
  { id: 'p12', name: 'E-commerce Starter', price: 600000, category: 'Digitalisation', desc: 'Vendez partout, tout le temps. Ouvrez votre boutique au monde entier et simplifiez vos encaissements. Une solution clé en main pour booster votre chiffre d\'affaires sans limites géographiques.', image: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&q=80&w=800' },
  { id: 'p13', name: 'Application Mobile MVP', price: 1500000, category: 'Digitalisation', desc: 'Soyez dans la poche de vos clients. Fidélisez votre audience avec une application mobile intuitive qui facilite l\'accès à vos services et renforce votre image de marque innovante.', image: 'https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&q=80&w=800' },
  { id: 'p24', name: 'Refonte Site Web', price: 200000, category: 'Digitalisation', desc: 'Redonnez vie à votre image numérique. Améliorez l\'expérience utilisateur et la vitesse de votre site pour réduire le taux de rebond et multiplier vos contacts qualifiés.', image: 'https://images.unsplash.com/photo-1531123897727-8f129e1bf08c?auto=format&fit=crop&q=80&w=800' },
  { id: 'p25', name: 'Intégration API Tierce', price: 150000, category: 'Digitalisation', desc: 'Faites communiquer vos outils. Automatisez le transfert de données entre vos logiciels pour éliminer les erreurs de saisie et libérer du temps pour vos tâches à haute valeur ajoutée.', image: 'https://images.unsplash.com/photo-1573164574048-f968d7ee9f20?auto=format&fit=crop&q=80&w=800' },
  
  // Gestion & Comptabilité
  { id: 'p2', name: 'Logiciel Gestion Comptable', price: 250000, category: 'Gestion', desc: 'Prenez des décisions basées sur des chiffres réels. Simplifiez votre tenue de compte et générez vos états financiers en un clic pour une visibilité totale sur votre santé financière.', image: 'https://images.unsplash.com/photo-1573165231977-3f0e27806045?auto=format&fit=crop&q=80&w=800' },
  ...
  { id: 'p26', name: 'Audit Comptable Annuel', price: 500000, category: 'Gestion', desc: 'Sécurisez votre patrimoine. Identifiez les risques et optimisez vos processus financiers pour rassurer vos partenaires et investisseurs grâce à une expertise certifiée.', image: 'https://images.unsplash.com/photo-1580894894513-541e068a3e2a?auto=format&fit=crop&q=80&w=800' },
  { id: 'p27', name: 'Externalisation Comptable', price: 150000, category: 'Gestion', desc: 'Concentrez-vous sur votre cœur de métier. Confiez votre comptabilité à nos experts et bénéficiez d\'un suivi rigoureux sans les coûts d\'un service interne.', image: 'https://images.unsplash.com/photo-1531123414780-f74242c2b052?auto=format&fit=crop&q=80&w=800' },
  { id: 'p28', name: 'Conseil en Trésorerie', price: 100000, category: 'Gestion', desc: 'Optimisez chaque franc. Maîtrisez vos flux de trésorerie pour anticiper vos besoins de financement et maximiser vos opportunités d\'investissement.', image: 'https://images.unsplash.com/photo-1573164574572-cb89e39749b4?auto=format&fit=crop&q=80&w=800' },

  // Formation
  { id: 'p3', name: 'Formation Expert Digital', price: 150000, category: 'Formation', desc: 'Devenez le leader de demain. Maîtrisez les outils qui transforment les industries. Cette formation vous donne les clés pour piloter des projets complexes et innover dans un monde numérique.', image: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&q=80&w=800' },
  { id: 'p9', name: 'Formation Excel Avancé', price: 85000, category: 'Formation', desc: 'Gagnez des heures de travail chaque semaine. Apprenez à automatiser vos rapports et à analyser des données complexes pour devenir l\'élément indispensable de votre équipe.', image: 'https://images.unsplash.com/photo-1573167243872-43c6433b9d40?auto=format&fit=crop&q=80&w=800' },
  { id: 'p10', name: 'Formation Management', price: 125000, category: 'Formation', desc: 'Inspirez l\'excellence. Développez un leadership authentique pour mobiliser vos équipes vers des objectifs ambitieux et créer un environnement de travail productif.', image: 'https://images.unsplash.com/photo-1518457607834-6e8d80c183c5?auto=format&fit=crop&q=80&w=800' },
  { id: 'p17', name: 'Formation Design Thinking', price: 95000, category: 'Formation', desc: 'Innovez par l\'empathie. Apprenez une méthodologie éprouvée pour résoudre des problèmes complexes et créer des produits que vos clients vont adorer.', image: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=800' },
  { id: 'p29', name: 'Formation Cybersécurité', price: 180000, category: 'Formation', desc: 'Protégez votre avenir numérique. Apprenez à identifier les menaces et à sécuriser vos données critiques pour éviter des pertes financières et réputationnelles majeures.', image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=800' },
  { id: 'p30', name: 'Atelier Intelligence Artificielle', price: 200000, category: 'Formation', desc: 'Ne vous laissez pas dépasser. Intégrez l\'IA générative dans votre quotidien pour multiplier votre créativité et votre vitesse d\'exécution par dix.', image: 'https://images.unsplash.com/photo-1543336302-602ee50f9ffb?auto=format&fit=crop&q=80&w=800' },

  // Marketing & Réseaux Sociaux
  { id: 'p5', name: 'Pack SEO Local', price: 120000, category: 'Marketing', desc: 'Soyez le premier choix dans votre ville. Dominez les résultats de recherche locaux pour attirer les clients qui cherchent vos services juste à côté de chez vous.', image: 'https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?auto=format&fit=crop&q=80&w=800' },
  { id: 'p6', name: 'Gestion Communauté (1 mois)', price: 200000, category: 'Marketing', desc: 'Créez un lien indéfectible avec votre audience. Transformez vos abonnés en ambassadeurs passionnés grâce à une animation experte et stratégique de vos réseaux.', image: 'https://images.unsplash.com/photo-1556761175-129418cb210d?auto=format&fit=crop&q=80&w=800' },
  ...
  { id: 'p19', name: 'Vidéo Corporate (1 min)', price: 250000, category: 'Marketing', desc: 'Racontez votre histoire avec impact. Captivez votre audience avec une vidéo de haute qualité qui humanise votre entreprise et explique clairement votre valeur ajoutée.', image: 'https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&q=80&w=800' },
  { id: 'p20', name: 'Rédaction Contenu (10 art.)', price: 100000, category: 'Marketing', desc: 'Devenez une autorité dans votre domaine. Attirez du trafic organique qualifié avec des articles experts qui répondent aux questions de vos futurs clients.', image: 'https://images.unsplash.com/photo-1531123897727-8f129e1bf08c?auto=format&fit=crop&q=80&w=800' },
  { id: 'p31', name: 'Campagne Google Ads', price: 300000, category: 'Marketing', desc: 'Des résultats immédiats. Ciblez précisément les personnes prêtes à acheter vos services et maximisez votre retour sur investissement publicitaire.', image: 'https://images.unsplash.com/photo-1573164574048-f968d7ee9f20?auto=format&fit=crop&q=80&w=800' },

  // Conseil & Audit
  { id: 'p4', name: 'Audit Digital Complet', price: 75000, category: 'Conseil', desc: 'Identifiez vos leviers de croissance. Obtenez une feuille de route claire pour moderniser votre structure et surpasser vos concurrents sur le plan technologique.', image: 'https://images.unsplash.com/photo-1573165231977-3f0e27806045?auto=format&fit=crop&q=80&w=800' },
  { id: 'p14', name: 'Support Technique (10h)', price: 100000, category: 'Conseil', desc: 'La tranquillité d\'esprit garantie. Bénéficiez d\'une assistance réactive pour résoudre vos blocages techniques et maintenir vos outils en parfait état de marche.', image: 'https://images.unsplash.com/photo-1573167101669-476636b96ea6?auto=format&fit=crop&q=80&w=800' },
  { id: 'p15', name: 'Conseil Stratégie Fiscale', price: 200000, category: 'Conseil', desc: 'Optimisez votre rentabilité. Naviguez sereinement dans la complexité fiscale de la zone CEMAC et réduisez vos charges en toute légalité.', image: 'https://images.unsplash.com/photo-1580894894513-541e068a3e2a?auto=format&fit=crop&q=80&w=800' },
  { id: 'p16', name: 'Audit Sécurité Informatique', price: 400000, category: 'Conseil', desc: 'Anticipez les cyberattaques. Dormez sur vos deux oreilles en sachant que vos systèmes sont protégés contre les intrusions et le vol de données.', image: 'https://images.unsplash.com/photo-1531123414780-f74242c2b052?auto=format&fit=crop&q=80&w=800' },
  { id: 'p23', name: 'Analyse Données PowerBI', price: 300000, category: 'Conseil', desc: 'Visualisez votre succès. Transformez vos données brutes en tableaux de bord parlants pour piloter votre activité avec une précision chirurgicale.', image: 'https://images.unsplash.com/photo-1573164574572-cb89e39749b4?auto=format&fit=crop&q=80&w=800' },
  { id: 'p32', name: 'Conseil Juridique Digital', price: 250000, category: 'Conseil', desc: 'Soyez en règle, soyez serein. Protégez votre entreprise et vos clients en vous conformant aux réglementations sur les données personnelles (RGPD/Loi locale).', image: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&q=80&w=800' },

  // Événementiel
  { id: 'p21', name: 'Gestion Projet Événementiel', price: 500000, category: 'Événementiel', desc: 'Marquez les esprits. Confiez-nous l\'organisation de vos événements pour une exécution sans faille qui valorise votre image auprès de vos partenaires.', image: 'https://images.unsplash.com/photo-1573167243872-43c6433b9d40?auto=format&fit=crop&q=80&w=800' },
  { id: 'p22', name: 'Solution Billetterie En Ligne', price: 150000, category: 'Événementiel', desc: 'Simplifiez l\'accès à vos événements. Offrez une expérience d\'achat fluide à vos participants et gérez vos entrées avec une technologie moderne et sécurisée.', image: 'https://images.unsplash.com/photo-1518457607834-6e8d80c183c5?auto=format&fit=crop&q=80&w=800' },
  { id: 'p33', name: 'Streaming Live Événement', price: 400000, category: 'Événementiel', desc: 'Élargissez votre audience. Diffusez vos conférences au-delà des murs de la salle et touchez des milliers de personnes en temps réel avec une qualité pro.', image: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=800' },
  { id: 'p34', name: 'Application Mobile Événement', price: 800000, category: 'Événementiel', desc: 'Engagez vos participants. Offrez un outil interactif pour le networking, l\'agenda et les questions-réponses, rendant votre événement inoubliable.', image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=800' },

  // Design
  { id: 'p7', name: 'Création Logo & Charte', price: 180000, category: 'Design', desc: 'Une identité qui impose le respect. Démarquez-vous avec un design unique qui communique instantanément vos valeurs et votre professionnalisme.', image: 'https://images.unsplash.com/photo-1543336302-602ee50f9ffb?auto=format&fit=crop&q=80&w=800' },
  ...
  { id: 'p36', name: 'Montage Vidéo Publicitaire', price: 150000, category: 'Design', desc: 'Vendez plus avec l\'image. Créez des spots percutants qui captent l\'attention en quelques secondes et poussent vos prospects à l\'action.', image: 'https://images.unsplash.com/photo-1556761175-129418cb210d?auto=format&fit=crop&q=80&w=800' },
  
  // Savoir & Développement
  { id: 'p37', name: 'Étude de Marché Afrique', price: 700000, category: 'Savoir', desc: 'Réduisez l\'incertitude. Obtenez des données terrain précises pour réussir votre implantation ou le lancement de votre nouveau produit sur le continent.', image: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&q=80&w=800' },
  { id: 'p38', name: 'Rapport Économique CEMAC', price: 300000, category: 'Savoir', desc: 'Anticipez les tendances régionales. Accédez à une analyse pointue des enjeux économiques pour orienter vos investissements stratégiques avec assurance.', image: 'https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&q=80&w=800' },
  { id: 'p39', name: 'Accompagnement Startup', price: 1000000, category: 'Savoir', desc: 'Passez de l\'idée au succès. Bénéficiez d\'un mentorat de haut niveau pour structurer votre projet, lever des fonds et accélérer votre croissance.', image: 'https://images.unsplash.com/photo-1531123897727-8f129e1bf08c?auto=format&fit=crop&q=80&w=800' },
  { id: 'p40', name: 'Conférence Thématique', price: 250000, category: 'Savoir', desc: 'Éclairez vos décisions. Profitez de l\'expertise de nos consultants sur les grands enjeux du numérique pour inspirer vos équipes et vos partenaires.', image: 'https://images.unsplash.com/photo-1573164574048-f968d7ee9f20?auto=format&fit=crop&q=80&w=800' }
];
