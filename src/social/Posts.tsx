...
import { 
  Filter, Calendar as CalendarIcon, MoreVertical, Edit2, Copy, Trash2, Send, Clock, Plus, X, Image as ImageIcon, Check
} from 'lucide-react';
import CreatePostModal from './CreatePostModal';

export default function Posts() {
  const { posts, deletePost, updatePost, addPost } = useSocial();
  ...
  const statusColors: any = {
    ...
    'ai-suggested': 'bg-amber-500/10 text-amber-400 border-amber-500/20'
  };
    ...
    <div className="space-y-6 min-h-full flex flex-col">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <button 
          ...
          className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2.5 rounded-full font-medium transition-colors shadow-lg shadow-purple-500/30 flex items-center gap-2"
        >
